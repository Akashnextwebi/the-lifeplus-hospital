<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="general-surgery.aspx.cs" Inherits="general_surgery" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="banner new-banner">
                                    <h1 class="handline">Specialized center for <span class="new-bold">General Surgery</span>
                                        Treatment</h1>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Types Of Treatment in General Surgery
                            </h3>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Top Doctors For General Surgery
                            </h3>
                        </div>
                    </div>
