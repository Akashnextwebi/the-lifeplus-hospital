<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="IVF-Infertility.aspx.cs" Inherits="IVF_Infertility" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="banner new-banner">
                                    <h1 class="handline">Specialized center for <span class="new-bold">Infertility</span>
                                        Treatment</h1>
                                    <p class="about-website">
Fertility treatment generally refers to the procedures followed to stimulate the egg or sperm production. The problem can be treated using numerous methods, such as fertility drugs, hormone treatments, medications, surgery, IVF, IUI, GIFT, and others. There are three main types of fertility treatments, i.e., medicines, surgical procedures, and assisted conception.
                                    </p>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Types Of Treatment in IVF / Infertility 
                            </h3>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Top Doctors For IVF / Infertility 
                            </h3>
                        </div>
                    </div>
