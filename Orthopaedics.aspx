<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="Orthopaedics.aspx.cs" Inherits="Orthopaedics" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="banner new-banner">
                                    <h1 class="handline">Specialized center for <span class="new-bold">Orthopaedics</span>
                                        Treatment</h1>
                                    <p class="about-website">
Enjoy maximum mobility without the fear of pain! Undergo minimally invasive surgery for your orthopaedic condition from the best orthopaedic surgeons and improve your overall quality of life. THE LIFE PLUS HOSPITAL Care is COVID 19 Safe Our Hospital premises are COVID safe Regular sanitization of clinic & hospital premises Immediate medical assistance through Online Consultation
                                    </p>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Types Of Treatment in Orthopaedics
                            </h3>
                        </div>
                    </div>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Top Doctors For Orthopaedics
                            </h3>
                        </div>
                    </div>
