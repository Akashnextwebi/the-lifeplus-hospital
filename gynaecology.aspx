<%@ Page Title="" Language="C#" MasterPageFile="./MasterPage.master" AutoEventWireup="true" CodeFile="gynaecology.aspx.cs" Inherits="gynaecology" %>
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-flex align-items-center justify-content-between">
                                <div class="banner new-banner">
                                    <h1 class="handline">Specialized center for <span class="new-bold">Gynecology</span>
                                        Treatment</h1>
                                    <p class="about-website">
                                        Gynecology is the medical practice dealing with the health of the female reproductive systems. Visit THE LIFE PLUS HOSPITAL for Most Advanced Treatment by highly experienced gynecologists.
                                    </p>
                ...
                <div class="col-lg-8">
                    <div class="sec-title sec-title-3 mb-5 ">
                        ...
                        <div class="text-center">
                            ...
                            <h3>Types Of Treatment in Gynecology
                            </h3>
                        </div>
                    </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-3">
                    <div class="featured-item style-1">
                        ...
                        <div class="featured-desc">
                            <div class="featured-title">
                                <h5>Menstrual Disorder - Irregular Periods
                                </h5>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-4">
                    <div class="doctor-card">
                        <div class="doctor-one">
                            <div class="doctor-pro">
                                <img class="img-fluid  w-25" src="assets/img/doc/2.png" alt="01 doctors">
                            </div>
                            <div class="doctor-conteent">
                                <h3>Dr. Shreedevi
                                </h3>
                                <h6>MBBS - M.D - Gynecologist,
                                </h6>
                                <h6 class="green">Free Consultation</h6>
                ...
                <div class="col-lg-4">
                    <div class="doctor-card">
                        <div class="doctor-one">
                            <div class="doctor-pro">
                                <img class="img-fluid  w-25" src="assets/img/doc/3.png" alt="01 doctors">
                            </div>
                            <div class="doctor-conteent">
                                <h3>Dr. Akshatha S

                                </h3>
                                <h6>MBBS - MS - Gynaecologist,
                                </h6>
                                <h6 class="green">Free Consultation</h6>
